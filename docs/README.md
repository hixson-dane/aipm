...
This directory contains the working design documentation for **aipm**, a package manager for agentic AI artifacts.
...
- [roadmap.md](roadmap.md) — phased implementation direction
